...
const LoginPage = () => {
  ...
  // console.log("user 11",isLoaded, isSignedIn, user);
  ...
  useEffect(() => {
    if (isLoaded && isSignedIn && user) {
      ...
      const userRole = user.publicMetadata?.role || user.username || "admin";
      ...
      if (typeof userRole === "string" && userRole.trim() !== "") {
        ...
        console.log("After redirect attempt:", window.location.href);
      } else {
